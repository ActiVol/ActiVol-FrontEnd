              ...
              <div class="flex items-center justify-between">
                <div class="flex items-center">
                  <div class="flex-shrink-0 h-12 w-12">
                    <img v-if="activity.posterUrl" :src="activity.posterUrl"
                         class="h-12 w-12 rounded-full object-cover" alt="Activity poster" />
                  ...
                  <div class="ml-4">
                    ...
                    <div class="mt-1 text-sm text-gray-500">
                      ...
                      {{ formatDate(activity.dates[0].date) }}
      ...
      <div v-else class="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
        <div v-for="activity in activities" :key="activity.id" class="bg-white shadow-md rounded-lg overflow-hidden">
          <div class="p-6">
            ...
            <div class="mb-4">
              <img v-if="activity.posterUrl" :src="activity.posterUrl" class="w-full h-40 object-cover rounded-md" alt="Activity poster" />
            ...
            <p class="text-sm text-gray-600 mb-4">{{ truncateContent(activity.content) }}</p>
...
const { fetchActivities, deleteActivity: apiDeleteActivity } = useActivities()
...
onMounted(async () => {
  activities.value = (await fetchActivities()).map(activity => ({
    ...activity,
...
const getTotalParticipants = (activity: Activity) => {
  return activity.dates.reduce((total, date) => total + (date.unlimited ? Infinity : date.participants), 0)
}
